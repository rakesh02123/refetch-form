        ...
        <Card>
          <CardBody className="w-[300px] space-y-2">
            ...
            <div className="grid grid-cols-7 items-center gap-2">
              {/*  */}
              <UsersIcon className="h-7" />
              <div className="font-bold text-lg col-span-6">{data.gender}</div>
              ...
              {/*  */}
              <InboxArrowDownIcon className="h-7" />
              <div className="font-bold text-lg col-span-6">{data.email}</div>
              ...
              <GlobeAltIcon className="h-7" />
              <div className="font-bold text-lg col-span-6">{data.nat}</div>
            </div>
          </CardBody>
        </Card>
      </div>
